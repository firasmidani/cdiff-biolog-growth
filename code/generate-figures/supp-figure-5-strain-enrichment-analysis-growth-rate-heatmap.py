...
df_results = read_csv('../../tables/strain_enrichment_analysis_norm_gr.tsv')
...
# SAVE FIGURE
plt.savefig(f"{dir_figure}/supp/supp-figure-5-strain-enrichment-growth-rate-heatmap.png",dpi=600,bbox_inches='tight',pad_inches=0.05)
plt.close()
