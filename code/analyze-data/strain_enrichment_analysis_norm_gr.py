...
# subtraction-normalized carrying capacity in the untransformed linear scale
param = 'norm(k_lin)'
...
df_summ = pd.read_csv(
    "../../amiga-biolog/summary/merged_summary_norm_sub_by_median_gr.txt",
    sep='\t',header=0,index_col=0,low_memory=False
)
...
# save results
df_results.to_csv('../../tables/strain_enrichment_analysis_norm_gr.tsv',sep="\t")
